...
const TOKENS: Record<PageId, string> = {
  ...
  inlinecalc:    '9c3f7b1e5a8d2046',
  nullvsblank:    '2a6d9f3c8b1e5047',
  noncorrelated:  '5a8e2f1b9c3d7046',
  correlated:     '6b9f3c2a1e8d5047',
  innotinanyall:  '7c1a5e4f9b2d8036',
  existsquery:    '8d2b6f3a5c9e1047',
  nestedsubqueries: '9e3c7a5b1f4d8260',
  ctesadv:        'a4f8c2e6b9d31507',
  unionall:       'b5d9a3f7c1e84026',
...
export const ROUTES = {
  ...
  inlinecalc:    `/q/${TOKENS.inlinecalc}`,
  nullvsblank:    `/q/${TOKENS.nullvsblank}`,
  noncorrelated:  `/q/${TOKENS.noncorrelated}`,
  correlated:     `/q/${TOKENS.correlated}`,
  innotinanyall:  `/q/${TOKENS.innotinanyall}`,
  existsquery:    `/q/${TOKENS.existsquery}`,
  nestedsubqueries: `/q/${TOKENS.nestedsubqueries}`,
  ctesadv:        `/q/${TOKENS.ctesadv}`,
  unionall:       `/q/${TOKENS.unionall}`,
